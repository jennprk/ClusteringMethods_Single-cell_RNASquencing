...
![Picture1](/Users/jieun/Desktop/Weill Cornell/Spring2018/CapstoneProject/Fall_Presentation/Picture1.png)
...
![Picture2](/Users/jieun/Desktop/Weill Cornell/Spring2018/CapstoneProject/Fall_Presentation/Picture2.png)
...
![Picture3](/Users/jieun/Desktop/Weill Cornell/Spring2018/CapstoneProject/Fall_Presentation/Picture3.png)
...
![Picture4](/Users/jieun/Desktop/Weill Cornell/Spring2018/CapstoneProject/Fall_Presentation/Picture4.png)
...
```
source("*[*https://bioconductor.org/biocLite.R*](https://bioconductor.org/biocLite.R)*"); biocLite("splatter")
```
...
$$
\underset { S }{ argmin } \sum _{ i=1 }^{ k }{ \sum _{ x\in { S }_{ i } }^{  }{ { \left\| \Chi -{ \mu  }_{ i } \right\|  }^{ 2 } }  } =\underset { s }{ argmin } \sum _{ i=1 }^{ k }{ \left| { S }_{ i } \right|  } Var{ S }_{ i }\\
...
The Rand index, R, is:
$$
R = \frac{a+b}{a+b+c+d}=\frac{a+b}{(\begin{matrix}{n}  \\ {2} \end{matrix})}
$$
...
![Picture5](/Users/jieun/Desktop/Weill Cornell/Spring2018/CapstoneProject/FinalScripts/Picture5.png)
